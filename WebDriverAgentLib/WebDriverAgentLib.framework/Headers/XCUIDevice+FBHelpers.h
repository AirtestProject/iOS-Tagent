...
// a faster method to get screenshot with jpeg-encoded data
- (nullable NSData *)fb_fast_screenshotWithError:(NSError*__autoreleasing*)error window_size:(CGSize)window_size orientation:(UIInterfaceOrientation)orientation;
